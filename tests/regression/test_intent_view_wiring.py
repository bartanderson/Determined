...
def _make_db_with_intent():
    ...
    conn.execute("INSERT INTO functions VALUES (NULL, 'f.py', 'activate', 10, NULL, '[]', 'Activate the widget.', 0, NULL)")
    conn.execute("INSERT INTO functions VALUES (NULL, 'f.py', 'helper', 20, NULL, '[]', NULL, 0, NULL)")
